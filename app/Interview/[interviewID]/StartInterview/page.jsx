          ...
          <div className=" flex flex-col space-y-3  ">
            ...
            <div className=" flex flex-col border-2 space-y-3 border-blue-300 p-2 bg-blue-200 rounded-lg">
              ...
              <p className=" capitalize text-justify text-blue-700 ">
                Click on the record button to answer each of the question. At
                the end of this mock interview, you will given the correct
                answers to these questions along with feedback of your given
                answers.
              </p>
            </div>
          </div>
